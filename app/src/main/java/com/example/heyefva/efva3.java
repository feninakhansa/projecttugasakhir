...
public class efva3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_efva3);
        ...
        tblAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isInserted == true)
                    Toast.makeText(efva3.this,"Data Terimpan",Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(efva3.this,"Data Gagal Tersimpan",Toast.LENGTH_LONG).show();
            }
        });
    }
    public void kembali(View view) {
        Intent intent = new Intent(efva3.this,Home.class);
